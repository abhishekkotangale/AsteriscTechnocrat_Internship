...
<?php
  ...
  ?>
      ...
      <main>
        <div class="container">
          <div class="jumbotron">
            <h1 class="display-3 text-center pb-3 pt-lg-4">
              Hello <?php
      ...
      <footer>
        <div class="footer-para text-center text-white p-1" style="background-color: black;">
            <p class="pt-2">Copyright © Lifestyle Store. All Rights Reserved | Contact Us: +91 90000 00000</p>
        </div>
    </footer>
